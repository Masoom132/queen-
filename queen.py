...
\033[1;34;40m-----------------------------------------------
\033[1;34;40m  THIS TOOL CREATED BY CHHATTISHGARH QUEEN RANI : INSIDE 
\033[1;34;40m  NAME : RANI SINGH
...
def sendtextconvo(comment):
    ...
    print(">> S0J4 MC AB ME D3KHL0NG9 BS ID LOCK NA JAYE :: ", line, "\n")

print("\033[1;33;40m", end = "")
os.system('clear')
print(logo)
sp("\033[1m\033[36m[ 😈 ]  GMAIL DALO  \n")
print(47*'\033[1;35;40m-')
USERNAME = str(input('[ 😢 ] EMAIL LIKH MERE    : '))
print("\033[1;33;40m", end = "")
print(47*'\033[1;35;40m-')
sp("\033[1m\033[36m[😠] PASSWORD DALO \n")
print(47*'\033[1;35;40m-')
PASSWORD = str(input('[?]  PASSWORD DAL : '))
login()
